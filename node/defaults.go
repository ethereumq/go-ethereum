...
func DefaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "EthereumQuantum")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home, "AppData", "Roaming", "EthereumQuantum")
		} else {
			return filepath.Join(home, ".ethereumquantum")
		}
	}
