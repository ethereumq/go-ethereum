...
import (
	...
	"github.com/ethereumq/go-ethereumq/crypto/ecies"
	"github.com/ethereumq/go-ethereumq/event/filter"
...
// New creates a Whisper client ready to communicate through the  Ethereum Quantum P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
