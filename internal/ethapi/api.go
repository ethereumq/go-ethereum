...
// PublicEthereumAPI provides an API to access  Ethereum Quantum related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new  Ethereum Quantum protocol API.
...
// ProtocolVersion returns the current  Ethereum Quantum protocol version this node supports
...
// Sign calculates an  Ethereum Quantum ECDSA signature for:
...
//
// https://github.com/ethereumq/go-ethereumq/wiki/Management-APIs#personal_sign
...
//
// https://github.com/ethereumq/go-ethereumq/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid  Ethereum Quantum signature (V is not 27 or 28)")
	}
...
// PublicBlockChainAPI provides an API to access the  Ethereum Quantum blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new  Ethereum Quantum blockchain API.
...
//
// https://github.com/ethereumq/wiki/wiki/JSON-RPC#eth_sign
...
// PublicDebugAPI is the collection of  Ethereum Quantum APIs exposed over the public
// debugging endpoint.
...
// of the  Ethereum Quantum service.
...
// PrivateDebugAPI is the collection of  Ethereum Quantum APIs exposed over the private
// debugging endpoint.
