...
// Package consensus implements different  Ethereum Quantum consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the  Ethereum Quantum address of the account that minted the given
