...
import (
	...
	"github.com/ethereumq/go-ethereumq/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the  Ethereum Quantum contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the  Ethereum Quantum contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the  Ethereum Quantum contract Solidity source to build and bind")
