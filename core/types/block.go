...
// Package types contains data types related to  Ethereum Quantum consensus.
package types
...
// Header represents a block header in the  Ethereum Quantum blockchain.
type Header struct {
...
// Block represents an entire block in the  Ethereum Quantum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the  Ethereum Quantum RLP block format.
