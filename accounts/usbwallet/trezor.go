...
import (
	...
	"github.com/ethereumq/go-ethereumq/accounts/usbwallet/internal/trezor"
...
// or whether the  Ethereum Quantum app was not started on it.
...
//  Ethereum Quantum address located on that path.
