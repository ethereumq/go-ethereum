...
// *
// Request: Ask device for  Ethereum Quantum address corresponding to address_n path
// @next PassphraseRequest
...
// *
// Response: Contains an  Ethereum Quantum address derived from device private seed
