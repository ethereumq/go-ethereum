...
// setting up a new or managing an existing  Ethereum Quantum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your  Ethereum Quantum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new  Ethereum Quantum network down to  |")
	...
	log.Info("Administering  Ethereum Quantum network", "name", w.network)
