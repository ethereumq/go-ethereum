...
type ContractCaller interface {
	...
	// ContractCall executes an  Ethereum Quantum contract call with the specified data as the
	// input.
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an  Ethereum Quantum contract call against the pending state.
