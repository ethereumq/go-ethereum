...
// versions of the go-ethereum implementation. Its goal is to allow gethq to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new gethq releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular gethq release
  struct Version {
