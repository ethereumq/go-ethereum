...
!define HELPURL "https://github.com/ethereumq/go-ethereumq/issues"
!define UPDATEURL "https://github.com/ethereumq/go-ethereumq/releases"
!define ABOUTURL "https://github.com/ethereumq/go-ethereumq#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:40303)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:40303)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:40303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:40303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 40303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:40303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 40303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:40303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 40303 "" ""

  # Set default IPC endpoint (https://github.com/ethereumq/EIPs/issues/147)
