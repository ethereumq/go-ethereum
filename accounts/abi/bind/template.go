...
import "github.com/ethereumq/go-ethereumq/accounts/abi"
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new  Ethereum Quantum contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around an  Ethereum Quantum contract.
	type {{.Type}} struct {
	  {{.Type}}Caller     // Read-only binding to the contract
	  {{.Type}}Transactor // Write-only binding to the contract
	}

	// {{.Type}}Caller is an auto generated read-only Go binding around an  Ethereum Quantum contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around an  Ethereum Quantum contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an  Ethereum Quantum contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an  Ethereum Quantum contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an  Ethereum Quantum contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around an  Ethereum Quantum contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around an  Ethereum Quantum contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around an  Ethereum Quantum contract.
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		{{if .InputBin}}
			...
			// deploy deploys a new  Ethereum Quantum contract, binding an instance of {{.Type}} to it.
		...
		//  Ethereum Quantum address where this contract is located at.
		public final Address Address;

		//  Ethereum Quantum transaction in which this contract was deployed (if known!).
