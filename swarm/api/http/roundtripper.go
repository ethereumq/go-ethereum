...
see https://github.com/ethereumq/go-ethereumq/issues/2040
Usage:

import (
 "github.com/ethereumq/go-ethereumq/common/httpclient"
 "github.com/ethereumq/go-ethereumq/swarm/api/http"
)
