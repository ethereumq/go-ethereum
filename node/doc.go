...
/*
Package node sets up multi-protocol  Ethereum Quantum nodes.
...
Node also creates the shared store of encrypted  Ethereum Quantum account keys. Services can access
